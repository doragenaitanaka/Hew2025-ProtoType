...
void	Stage_3::Initialize(void)
{
    ...
    if (!this->rail) { this->rail = std::make_shared<Object>(this->p_camera); }
    ...
    player->SetPos(5200.0f, -1770.0f, 0.0f);
    Vx = 0.0f;
    Vy = 0.0f;
    t = 0;
    t2 = 0;
...
void	Stage_3::Update(void)
{
    ...
    if (gamemode == 1)
    {
        ...
        // ========================================
        // 降下したら死ぬ！！
        if (playerPos.y <= -2000.0f && (!this->player->GetIsDead()))
        {
            // ターゲットの解除
        ...
        this->goal->SetPos(300.0f, -890.0f, playerPos.z);
